...
import { Activity, Braces, ChevronDown, ChevronRight, Clipboard, Code2, Copy, Download, FileCode2, FilePlus2, FileSearch, Folder, FolderGit2, FolderPlus, GitBranch, PanelBottomClose, PanelBottomOpen, Play, Plus, Search, Server, SquareTerminal, Trash2, Upload, X } from "lucide-react";
